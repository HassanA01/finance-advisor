    ...
    <div className="min-h-screen bg-[#0a0a0b] flex">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden items-center justify-center">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute top-[15%] right-[15%] w-[1px] h-[250px] bg-gradient-to-b from-transparent via-amber-500/15 to-transparent" />
          <div className="absolute top-[55%] left-[12%] w-[1px] h-[180px] bg-gradient-to-b from-transparent via-amber-500/10 to-transparent" />
          <div className="absolute top-[30%] left-[25%] w-[150px] h-[1px] bg-gradient-to-r from-transparent via-amber-500/15 to-transparent" />
          <div className="absolute bottom-[25%] right-[20%] w-[100px] h-[1px] bg-gradient-to-r from-amber-500/15 to-transparent" />
        </div>

        {/* Floating shapes */}
        <div className="absolute top-[20%] left-[20%] w-20 h-20 border border-amber-500/[0.08] rotate-12 rounded-sm" />
        <div className="absolute bottom-[25%] right-[25%] w-28 h-28 border border-amber-500/[0.06] -rotate-12 rounded-sm" />
        <div className="absolute top-[50%] left-[35%] w-6 h-6 bg-amber-500/[0.05] rotate-45 rounded-sm" />
        ...
        <div className="relative z-10 px-16 max-w-xl">
          ...
          <h1 className="font-serif text-5xl leading-[1.15] text-white/95 mb-6 tracking-tight">
            Start your
            <br />
            <span className="text-amber-400/90">journey.</span>
          </h1>
          <p className="text-white/40 text-lg leading-relaxed max-w-sm">
            Upload your statements. Set your goals. Let AI guide you toward
            smarter spending — one month at a time.
          </p>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-10">
            ...
            <p className="text-white/40 text-sm">
              Set up your profile to get personalized advice
            </p>
          </div>
